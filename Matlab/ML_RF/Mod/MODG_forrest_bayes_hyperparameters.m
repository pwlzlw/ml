...
[train,test] =  splitFeatures(Features);
    ...
    bayes(Features.walking,Features.turnR,Features.turnL);
    ...
    function bayes(varargin)
        ...
        minSP = optimizableVariable('minSP',[1,15],'Type','integer');
    ...
    function oobErr = oobErrRF(params,X)  
        randomForest = TreeBagger(7,X,'Label','method','classification','OOBPrediction','on','MinLeafSize',params.minLS,...
