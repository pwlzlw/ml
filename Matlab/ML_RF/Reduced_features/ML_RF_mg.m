...
i = 42;
    ...
    function [lossv] = predictors()
        for j=1:10000
            ...
            losst = validateKNN(test.walking,test.turnR,test.turnL, kNNModel);        
            lossv(j) = 1 - losst;
        end
    end
    ...
    function model = trainPlotKNN(varargin) 
        ...
        md = TreeBagger(10,trainingTable,labels,'method','classification','OOBPrediction','on','MinLeafSize',47,...
        'MaxNumSplits',5);  
        %{
