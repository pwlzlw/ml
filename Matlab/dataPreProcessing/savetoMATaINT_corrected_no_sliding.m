...
%mislabeling during the experiment 
L = turnL5.Label;
turnL5(:,5) = turnR5(:,5);
turnR5(:,5) = L; 
...
save(['dataACCintMK3.mat'],'sitting','lying','standing','running','jumping','exercising','walking','turnR','turnL');
