...
%Date : 30/11/2017
%feeature extraction and data trimming for the gyroscope data
function ML_01() 
clear all;
close all;
% Constants
...
dataCellArray = getData(fileList, gyr);
%%
...
save(['dataGYRintMK2.mat'],'sitting','lying','standing','running','jumping','exercising','walking','turnR','turnL');
