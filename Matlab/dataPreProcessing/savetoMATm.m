...
save(['dataMAGint.mat'],'sitting','lying','standing','running','jumping','exercising','walking','turnR','turnL');
...
%feature extraction
    function features = extractFeatures(rawData,window,label_1)
        ...
        mag{i} = getIMA(accX(indexStart:indexEnd), accY(indexStart:indexEnd)...
        ...
        features.Properties.VariableNames = {'MmuX','MmuY','MmuZ','MvaX','MvaY','MvaZ','MsiX','MsiY','MsiZ',...
            'MmaX','MmaY','MmaZ','MmiX','MmiY','MmiZ','MmeX','MmeY','MmeZ','Label'};
    end
